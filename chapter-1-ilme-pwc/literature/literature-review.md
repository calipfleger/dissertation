...
::: {.under-review}
A new isotope-enabled modelling study provides methodological precedent for disentangling ENSO amplitude versus mean-state effects on regional precipitation δ¹⁸O, directly informing the interpretive framework of this chapter. [@wong2026holocene] used the ECHAM4.6 isotope-enabled atmospheric GCM to isolate the contributions of (1) reduced ENSO variability and (2) a La Niña-like tropical Pacific mean state on mid-Holocene South American precipitation and precipitation δ¹⁸O, finding that the mean-state shift — not reduced ENSO variability — dominates the regional isotopic response. This result is instructive for Chapter 1's use of iCESM δ¹⁸O as a Walker Circulation tracer: if a systematic mean-state shift (such as the post-volcanic SST pattern) dominates over changes in ENSO amplitude, then δ¹⁸O-based reconstructions can preferentially capture forced changes in circulation rather than confounded variance from ENSO event frequency. The study thus provides methodological validation for using isotope-enabled simulations to partition Walker Circulation signals in proxy archives, even when those archives also record ENSO variability. ⚠ relevance uncertain — geographic focus is South America, not Pacific; volcanic forcing is not examined; iCESM and ECHAM4.6 differ substantially in physics and resolution.
:::

## References (2026-05-30 phase-4)
- Wong, M. L., & Wang, X. (2026). The relative impacts of tropical Pacific teleconnections and local insolation on mid-Holocene precipitation over tropical South America. *Climate of the Past*, 22, 1–16. [10.5194/cp-22-1-2026](https://doi.org/10.5194/cp-22-1-2026) ⚠ relevance uncertain
...
- Zhang, Z. et al. (2024). Early emergence and determinants of human-induced Walker circulation weakening. *Nature Communications*, 15, 9161. [10.1038/s41467-024-53509-6](https://doi.org/10.1038/s41467-024-53509-6)
...
<!-- AUTO 2026-08-28 phase-4 -->
## References (2026-08-28 phase-4)
- Oppo, D. W., & Ummenhofer, C. C. (2026). Coupling of Pacific and Indian Ocean variability disrupted by 19th century volcanism. *Nature Communications*, 17(1), 8572. [10.1038/s41467-026-76705-y](https://doi.org/10.1038/s41467-026-76705-y)

Relevance to Chapter 1: this is a proxy-based reconstruction of the Pacific Walker circulation itself, alongside the Indian Ocean Walker circulation and basin mode, over the past four centuries — the same target this chapter approaches through iCESM Last Millennium Ensemble output and precipitation δ18O. Oppo and Ummenhofer [@oppo2026indopacific] report that the Indian Ocean modes were largely coupled to the Pacific throughout the pre-industrial era, that early-19th-century volcanism temporarily disrupted that coupling, and that the PWC–IOBM relationship since the mid-20th century is nonetheless exceptional relative to equivalent-length pre-industrial windows, including strongly volcanic ones. That last point speaks to this chapter's central forced-versus-internal question from the proxy side: it offers a paleoclimate benchmark against which a modelled anthropogenic PWC-weakening signal [@zhang2024walker] can be judged as unusual or not, and it makes inter-basin coupling a candidate diagnostic alongside the δ18O fingerprint.

_Retrieved via WebSearch (semanticSearch substitute — see the 2026-08-28 pipeline log note) · Metadata verified against the Nature publisher landing page · Summary generated by AI, verify claims against the source document · Last corpus update: 2026-08-28_
