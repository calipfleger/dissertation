...
<!-- AUTO 2026-05-28 phase-4 -->
::: {.under-review}
The discourse around climate geoengineering has undergone a structural shift over the past two decades — moving from a fringe scientific speculation to a mainstream topic across scientific institutions, news media, and legislative bodies. [@jacobson2025discourse] traces this trajectory through critical discourse analysis of three genres: scientific society reports, news journalism, and congressional hearings, finding that legitimising narratives — centred on technological necessity under escalating climate emergency — have progressively normalised both SRM and CDR in each of these arenas. The relevance for Chapter 5 is methodological as well as substantive: if geoengineering coverage has moved through a structural marginalisation-to-mainstreaming arc over the GDELT observation window (2015–2024), then temporal trends in VADER compound scores may partly reflect this legitimacy shift rather than — or in addition to — changing public or journalistic evaluations of the technologies themselves. A robustness check comparing pre- and post-2019 sentiment slopes, stratified by article source tier (elite science press vs. general news), would allow Chapter 5 to test whether the observed sentiment trajectory co-varies with the discourse normalisation described by Jacobson. ⚠ relevance uncertain — discourse analysis rather than quantitative NLP; verify article vs. book review attribution before final citation.
:::

## References (2026-05-28 phase-4)
- Jacobson, B. (2025). Geoengineering discourse confronting climate change: the move from margins to mainstream in science, news media, and politics. *Environmental Politics*, 34(7). [10.1080/09644016.2025.2481706](https://doi.org/10.1080/09644016.2025.2481706)

_Results retrieved via WebSearch · Summary generated by AI — verify claims against source documents · Last corpus update: 2026-05-28_

<!-- AUTO 2026-08-10 phase-4 -->
## References (2026-08-10 phase-4)
- Teodor, C. (2024). Sentiment analysis of global news on environmental issues: insights into public perception and its impact on low-carbon economy transition. *Frontiers in Environmental Science*, 12, 1360304. [10.3389/fenvs.2024.1360304](https://doi.org/10.3389/fenvs.2024.1360304)
...
::: {.under-review}
Sentiment scores describe valence but not the rhetorical structure producing it, and one specific structure now dominates carbon-removal communication. [@markusson2026doingboth] identify and criticise the "we need to do both" frame — the near-ubiquitous claim that CDR and emissions reductions are jointly required, asserted without saying what the combination means or how it would be achieved. Their argument is that the frame is empty and performative: it is deployed precisely to defuse the mitigation-deterrence concern that pursuing removal delays cuts, yet because it never specifies proportions or sequencing it does little to actually counteract that risk. Careful framing, they argue, must state CDR's relatively minor role compared with emissions reductions on any path to net zero. For Chapter 5 the value is that this is a named, operationalisable frame rather than a diffuse attitude, and it is one that lexicon methods are structurally blind to: "we need to do both" is affectively neutral-to-positive and will register as such in VADER, while carrying a deterrence function the sentiment score cannot see. That suggests a concrete extension — a keyword or classifier pass over the CDR sub-corpus for co-occurrence of removal terms with reduction terms in a conjunctive construction, scored separately from valence — which would let the chapter test whether the frame's prevalence in news coverage tracks, diverges from, or is simply orthogonal to the measured sentiment trend. It also gives an interpretive caution for the NbS/CDR/SRM comparison: a rise in CDR positivity may reflect the spread of this framing device rather than a genuine warming of evaluation. Note the authorship overlap with [@markusson2022natural], already cited in this chapter.
:::

## References (2026-08-30 phase-4)
- Markusson, N., von Rothkirch, J., & Dooley, K. (2026). Beyond 'doing both'—framing carbon removal carefully. *Frontiers in Climate*, 8, 1744296. [10.3389/fclim.2026.1744296](https://doi.org/10.3389/fclim.2026.1744296)

_Retrieved via WebSearch (semanticSearch substitute — see the 2026-08-18 pipeline log note) · DOI, journal, volume, article number, publication date and full author byline verified against the Frontiers article page · Summary generated by AI from the published abstract — verify claims against the full text · Last corpus update: 2026-08-30_

<!-- AUTO 2026-09-02 phase-4 -->
::: {.under-review}
A second 2026 study pushes the same critique of valence-only measurement further down into the language itself. [@vanbruggen2026vacuuming] apply critical metaphor analysis to news coverage of carbon-dioxide removal, and their corpus is close enough to this chapter's to be treated as a companion: articles on CDR from major UK, US and Canadian outlets over 2018--2024. What they find is that the framing work is done by metaphor rather than by evaluative adjectives, and that the source domains in play are strikingly heterogeneous — historical events, household objects, crime, religion, medicine — deployed differently by journalists than by the industry, science and civil-society sources they quote. The methodological consequence for Chapter 5 is direct and uncomfortable. A metaphor such as "vacuuming the sky" is doing heavy interpretive work, positioning removal as janitorial and therefore both feasible and faintly demeaning, yet it contains no lexicon-scored sentiment terms at all and will pass through VADER and the NRC lexicon as near-neutral. The same is true in the other direction for medical and crime metaphors, which import evaluation that a valence lexicon will either miss or misattribute to the surrounding sentence. Read alongside [@markusson2026doingboth], this suggests the chapter's CDR sub-corpus is being framed along at least two axes that its current instruments cannot see, and that the honest move is not to bolt on a metaphor classifier but to state plainly in the methods what lexicon-based sentiment does and does not measure. The two papers also give the chapter a citable basis for a limitation it would otherwise have to assert on its own authority. ⚠ Author byline verified only against search metadata and a third-party index — see the bibliography note.
:::

## References (2026-09-02 phase-4)
- van Bruggen, F., Reijnierse, W. G., Groot Kormelink, T., Hoey, E., & te Molder, H. (2026). Vacuuming the sky? Metaphorical framing in news coverage of carbon dioxide removal methods. *Environmental Communication*. [10.1080/17524032.2026.2673348](https://doi.org/10.1080/17524032.2026.2673348)

_Retrieved via WebSearch (semanticSearch substitute — see the 2026-08-18 pipeline log note) · Title, DOI and journal cross-verified against two independent listings; the Taylor & Francis page itself returned an empty body for the 4th consecutive run, so the full author byline is from search metadata and is flagged as unconfirmed · Summary generated by AI from the published abstract — verify claims against the full text · Last corpus update: 2026-09-02_
